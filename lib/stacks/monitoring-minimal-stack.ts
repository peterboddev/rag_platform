...
export interface MonitoringMinimalStackProps extends cdk.StackProps {
...
export class MonitoringMinimalStack extends cdk.Stack {
  public readonly dashboard: cloudwatch.Dashboard;
  public readonly alarmTopic: sns.Topic;

  constructor(scope: Construct, id: string, props: MonitoringMinimalStackProps) {
